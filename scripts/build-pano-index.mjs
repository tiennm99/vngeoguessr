...
// Validated before the loop. A stray code -- 'DL' was a province two commits
// ago -- would otherwise spend ~2,800 tile requests against a 50,000/day cap
// and write an artifact the seed script then refuses as not-a-province.
...
console.log('\ndone. Next: node scripts/assign-pano-districts.mjs, then node scripts/seed-pano-db.mjs');
